...
namespace Yarp
{
	public class IFrameGrabberRgb : IDisposable
	{
		...
		public virtual bool getRgbBuffer(SWIGTYPE_p_unsigned_char buffer)
		{
			bool ret = yarpPINVOKE.IFrameGrabberRgb_getRgbBuffer(swigCPtr, SWIGTYPE_p_unsigned_char.getCPtr(buffer));
			return ret;
		}
