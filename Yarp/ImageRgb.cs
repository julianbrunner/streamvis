...
namespace Yarp
{
	public class ImageRgb : Image
	{
		...
		internal ImageRgb(IntPtr cPtr, bool cMemoryOwn)
			: base(yarpPINVOKE.ImageRgbUpcast(cPtr), cMemoryOwn)
		{
		...
		{
			PixelRgb ret = new PixelRgb(yarpPINVOKE.ImageRgb_safePixel(swigCPtr, x, y), false);
			return ret;
		}

		public ImageRgb()
			: this(yarpPINVOKE.new_ImageRgb(), true)
		{
		}
