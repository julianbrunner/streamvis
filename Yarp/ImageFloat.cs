...
namespace Yarp
{
	public class ImageFloat : Image
	{
		...
		internal ImageFloat(IntPtr cPtr, bool cMemoryOwn)
			: base(yarpPINVOKE.ImageFloatUpcast(cPtr), cMemoryOwn)
		{
		...
		{
			SWIGTYPE_p_float ret = new SWIGTYPE_p_float(yarpPINVOKE.ImageFloat_safePixel(swigCPtr, x, y), false);
			return ret;
		}
		...
		public ImageFloat()
			: this(yarpPINVOKE.new_ImageFloat(), true)
		{
		}
